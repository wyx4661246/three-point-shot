package com.malzahar.tps.namesrv.routeInfoManager;
...
import com.malzahar.tps.common.protocol.body.ClusterInfo;
import com.malzahar.tps.common.protocol.body.TopicConfigSerializeWrapper;
import com.malzahar.tps.common.protocol.body.TopicList;
import com.malzahar.tps.common.protocol.route.BrokerData;
import com.malzahar.tps.common.protocol.route.QueueData;
import com.malzahar.tps.common.protocol.route.TopicRouteData;
import com.malzahar.tps.common.sysflag.TopicSysFlag;
...
public class RouteInfoManager {
    ...
    private final static Logger log = LoggerFactory.getLogger(RouteInfoManager.class);
            ...
            try {
                ...
                if (null != topicConfigWrapper
                    ...
                    if (this.isBrokerTopicConfigChanged(brokerAddr, topicConfigWrapper.getDataVersion())
                        ...
                        if (tcTable != null) {
                            for (Entry<String, TopicConfig> entry : tcTable.entrySet()) {
    ...
    public List<String> getActiveBroker() {
        List<String> brokerLives = new ArrayList<>();
        Iterator<Entry<String, BrokerLiveInfo>> it = this.brokerLiveTable.entrySet().iterator();
        while (it.hasNext()) {
            Entry<String, BrokerLiveInfo> next = it.next();
            brokerLives.add(next.getKey());
        }
        return brokerLives;
    }
    ...
    public byte[] getSystemTopicList() {
        ...
        try {
            try {
                this.lock.readLock().lockInterruptibly();
                for (Entry<String, Set<String>> entry : clusterAddrTable.entrySet()) {
