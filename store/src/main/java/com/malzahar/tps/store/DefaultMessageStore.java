...
import com.malzahar.tps.common.*;
...
import com.malzahar.tps.common.running.RunningStats;
import com.malzahar.tps.common.sysflag.MessageSysFlag;
import com.malzahar.tps.store.config.StorePathConfigHelper;
import com.malzahar.tps.store.ha.HAService;
import com.malzahar.tps.store.index.IndexService;
import com.malzahar.tps.store.index.QueryOffsetResult;
import com.malzahar.tps.store.schedule.ScheduleMessageService;
...
import static com.malzahar.tps.store.config.BrokerRole.SLAVE;


public class DefaultMessageStore implements MessageStore {

    private final static Logger log = LoggerFactory.getLogger(ConsumeQueue.class);
    ...
    private volatile boolean isLongPollingEnable = false;
    ...
    public DefaultMessageStore(final MessageStoreConfig messageStoreConfig, final BrokerStatsManager brokerStatsManager,
                               final MessageArrivingListener messageArrivingListener, Boolean isLongPollingEnable) throws IOException {
        ...
        this.isLongPollingEnable = isLongPollingEnable;
                        ...
                        for (int readSize = 0; readSize < result.getSize() && doNext; ) {
                            ...
                            if (dispatchRequest.isSuccess()) {
                                ...
                                if (size > 0) {
                                    ...
                                    doNext = false;
                                    // todo if (DefaultMessageStore.this.brokerConfig.getBrokerId() == MixAll.MASTER_ID) {
