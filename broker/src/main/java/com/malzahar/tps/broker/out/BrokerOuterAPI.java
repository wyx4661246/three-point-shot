package com.malzahar.tps.broker.out;


import com.malzahar.tps.broker.exception.MQBrokerException;
...
import com.malzahar.tps.common.Namesrv.TopAddressing;
...
import com.malzahar.tps.common.protocol.body.*;
import com.malzahar.tps.common.thread.FixedThreadPoolExecutor;
import com.malzahar.tps.remoting.RPCHook;
import com.malzahar.tps.remoting.RemotingClient;
import com.malzahar.tps.remoting.exception.*;
...
import com.malzahar.tps.remoting.protocol.header.namesrv.*;
...
public class BrokerOuterAPI {
    private final static Logger log = LoggerFactory.getLogger(BrokerOuterAPI.class);
    private final RemotingClient remotingClient;
    private final TopAddressing topAddressing = new TopAddressing(MixAll.getWSAddr());
    private String nameSrvAddr = null;
    private FixedThreadPoolExecutor brokerOuterExecutor = new FixedThreadPoolExecutor(4, 10, 1, TimeUnit.MINUTES,
